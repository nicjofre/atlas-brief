...
import { GOOGLE_ADS_ID, GA4_ID } from '@/lib/analytics/conversions'
...
//
// The IDs live in lib/analytics/conversions.ts so the event helpers can address
// GA4 directly (send_to) without the two files drifting apart.
